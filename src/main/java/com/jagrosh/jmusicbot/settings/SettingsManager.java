...
public class SettingsManager implements GuildSettingsManager
{
        ...
        try {
            ...
            loadedSettings.keySet().forEach((id) -> {
                ...
                settings.put(Long.parseLong(id), new Settings(this,
                        ...
                        o.has("playlist_pages")  ? o.getInt("playlist_pages")                : 6));
            });
    ...
    {
        return new Settings(this, 0, 0, 0, 100, null, RepeatMode.OFF, null, SKIP_RATIO, 6);
    }
    ...
    protected void writeSettings()
    {
        ...
        settings.keySet().stream().forEach(key -> {
            ...
            if(s.getPlaylistPages() != 6)
                o.put("playlist_pages", s.getPlaylistPages());
